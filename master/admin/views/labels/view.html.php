...
class CCMarketplaceViewLabels extends JView {
	...
	function display($tpl = null) {
		...
		JToolBarHelper::title( "CCMarketplace - " . JText::_('CCMP_LABELS'), "marketplace.png");
		...
		JSubMenuHelper::addEntry(JText::_('CCMP_LABELS'), 'index.php?option=com_ccmarketplace&view=labels', true);
