...
?>
<div class="ccmarketplace_random_module">
...
$id                 = $params->get('id', '');
 if(!empty($ads)){
 ?>
 <div class="random_module_inner_vertical">
 <?php
 foreach ($ads as $ad) {
...
?>
    <div class="vertical_contenedor" style="width:<?php echo $params->get('ad_width','167px'); ?>;font-size:<?= $fontsize; ?>px;">
	<table class="vertical_list" onclick="self.location='index.php?option=com_ccmarketplace&view=ads&layout=default_detailview3&module=2&adid=<?php echo $ad->id;?>&id=<?php echo $id;?>&shse=n'" style="width:<?php echo $params->get('ad_width','167px'); ?>;height:<?php echo $params->get('ad_height','180px'); ?>;">
	   <?php if($itoshow == 1 || $itoshow == 3) :
		...
		?>
	   <tr class="vertical_imagen" style="height:<?= $new_height + 10; ?>px;">
			<td>
       ...
       <tr class="vertical_text">
            <td><?php echo $title ?></td>
       </tr>
       <tr class="vertical_price">
...
<?php /*
<tr class="vertical_price">
            <td> echo $ad->publicationStart </td>
       </tr>*/
	   ?>
