...
class CCMarketplaceViewCategories extends JView {
	...
	function display($tpl = null) {
		...
		JToolBarHelper::title( "CCMarketplace - " . JText::_('CCMP_CATEGORIES'), "marketplace.png");
		...
		JSubMenuHelper::addEntry(JText::_('CCMP_CATEGORIES'), 'index.php?option=com_ccmarketplace&view=categories', true);
