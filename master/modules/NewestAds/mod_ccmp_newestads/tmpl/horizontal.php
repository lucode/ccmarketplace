...
JHTML::_('stylesheet', '#FF0000e.css', 'compo#FF0000nents/com_ccmarketplace/assets/');
...
?>
	...
	<table class="horizontal_list" onclick="self.location='index.php?option=com_ccmarketplace&view=ads&layout=default_detailview3&module=2&adid=<?php echo $ad->id;?>&id=<?php echo $id;?>&shse=n'" style="width:<?php echo $params->get('ad_width','167px'); ?>;height:<?php echo $params->get('ad_height','180px'); ?>;">
