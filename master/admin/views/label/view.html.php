...
class CCMarketplaceViewLabel extends JView {
	...
	function display($tpl = null) {
		...
		JToolBarHelper::title(   "CCMarketplace - " . JText::_('CCMP_LABEL') . ': <small><small>[ ' . $text.' ]</small></small>', "marketplace.png" );
		...
		JSubMenuHelper::addEntry(JText::_('Labels'), 'index.php?option=com_ccmarketplace&view=labels', true);
