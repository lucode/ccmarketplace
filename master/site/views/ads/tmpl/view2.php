...
<div class="view2_contmain"> 
 <div class="view2_contenedor"> --> 
   <table class="view2"> 
	<tr>
		<th><?php echo JText::_("CCMP_PICTURE"); ?></th>
		<th><?php echo JText::_("CCMP_NAME"); ?></th>
		<th><?php echo JText::_("CCMP_AD_TITLE"); ?></th>
		<th><?php echo JText::_("CCMP_PRICE"); ?></th>
		<th><?php echo JText::_("CCMP_DATE"); ?></th>
	</tr>
  <?php    // ********** BEGIN  geting ads   ************** -->
  $i = 0;
  foreach ($ads as $ad) {
    $title                = $ad->title;
    $desc                 = $ad->description;
  ...
  ?> 
       <tr class="row<?php echo $i % 2; ?>">
             <td id="view2_img"> <img src="<?php echo $image_url; ?>"/></td>
             <td>
             ...
             <td id="ccmp_view2_title"><a href='index.php?option=com_ccmarketplace&view=ads&layout=default_detailview3&adid=<?php echo $ad->id;?>&menu_id=<?php echo $this->active_mid; ?>&id=<?php echo $id;?>&shse=n'><?php echo $title ?></a></td>
             <td id="ccmp_view2_center" align="<?php echo $price ? "center" : "center"; ?>" ><?php echo $price ? $price : "-"; ?></td>
             <td id="ccmp_view2_center"> <?php $time = strtotime($ad->publicationStart); echo date('d.m.Y', $time); ?></td>
       </tr>
  <?php
	$empty_ads[] = 0;
	$i += 1;
