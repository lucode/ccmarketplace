...
class CCMarketplaceModelLabels extends JModel {
	...
	function _buildQuery() {
		...
		$query = "SELECT id, name, ordering, published FROM #__ccmarketplace_labels " . $where . $orderby;
	...
	function _buildContentOrderBy() {
		...
		if ($filter_order == 'ordering'){
			...
			$orderby 	= ' ORDER BY ordering ASC '.$filter_order_Dir;
	...
	function publish( $cid = array(), $publish = 1) {
		...
		if (count( $cid )) {
			...
			$query = 'UPDATE #__ccmarketplace_labels'
