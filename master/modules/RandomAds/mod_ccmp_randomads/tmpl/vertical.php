...
$id                 = $params->get('id', '');
 if(!empty($ads)){
 ?>
 <div class="random_module_inner_vertical" id="<?= $mod_id; ?>">
 <?php
 foreach ($ads as $ad) {
...
?>
	...
	<table class="vertical_list" onclick="self.location='index.php?option=com_ccmarketplace&view=ads&layout=default_detailview3&module=1&adid=<?php echo $ad->id;?>&id=<?php echo $id;?>&shse=n'" style="width:<?php echo $params->get('ad_width','167px'); ?>;height:<?php echo $params->get('ad_height','180px'); ?>;">
