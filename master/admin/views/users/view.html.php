...
class CCMarketplaceViewUsers extends JView {
	...
	function display($tpl = null) {
		...
		JToolBarHelper::title( "CCMarketplace - " . JText::_('CCMP_USERS'), "marketplace.png");
		...
		JSubMenuHelper::addEntry(JText::_('CCMP_USERS'), 'index.php?option=com_ccmarketplace&view=users', true);
